  ...
  describe('the Network service', () => {
    ...
    describe('for specific endpoints', () => {
      ...
      it('should getCollection', () => {
        ...
        $httpBackend.flush();
        $httpBackend.expectGET(/^\/rest\/collections\/certified-products\?fields=id,edition,curesUpdate,developer,product,version,chplProductNumber,certificationStatus,acb,surveillanceCount,openSurveillanceNonConformityCount,closedSurveillanceNonConformityCount,directReviewCount,openDirectReviewNonConformityCount,closedDirectReviewNonConformityCount$/).respond(200, {data: 'response'});
