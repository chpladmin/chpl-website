...
function ChplRwtResultsWizardSection4() {
      ...
      <Card>
        <CardContent className={classes.cardContent}>
          ...
          <Typography variant="body1" align="center">
            Thank you for submitting a change to your listing(s)’s Real World Testing Results URL. An email confirmation has been sent to the registered CHPL users associated with
            {' '}
            {developer.name}
...
export default ChplRwtResultsWizardSection4;

ChplRwtResultsWizardSection4.propTypes = {
};
