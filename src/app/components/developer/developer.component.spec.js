    ...
    describe('the Developer component', () => {
        ...
        beforeEach(() => {
            ...
            inject((_$compile_, _$log_, $rootScope) => {
                ...
                el = angular.element('<chpl-developer developer="developer" can-edit="canEdit" can-merge="canMerge" can-split="canSplit" on-edit="onEdit()" on-split="onSplit()" products="products" show-products="showProducts"></chpl-developer>');
