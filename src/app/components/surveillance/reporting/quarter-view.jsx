            ...
            <Card>
              ...
              <CardContent>
                ...
                <Box className={classes.summaryGroup}>
                  ...
                  <Typography className={classes.question} variant="body2" gutterbottom>The ONC-ACB used the following selection method to make its random selection of certified Health IT Modules for surveillance initiated during the reporting period.</Typography>
                  {report.surveillanceActivitiesAndOutcomes ? (
                    <Typography className={classes.responseBox}>{report.surveillanceActivitiesAndOutcomes}</Typography>
                  ) : (
                    <Typography className={classes.responseBox}>No response entered</Typography>
                  )}
                ...
                <Box className={classes.summaryGroup}>
                  ...
                  {report.reactiveSurveillanceSummary ? (
                    <Typography className={classes.responseBox}>{report.reactiveSurveillanceSummary}</Typography>
                  ) : (
                    <Typography className={classes.responseBox}>No response entered</Typography>
                  )}
                </Box>
                <Box className={classes.summaryGroup}>
                  ...
                  {report.icsSurveillanceSummary ? (
                    <Typography className={classes.responseBox} style={{ maxHeight: '500px', overflowY: 'auto' }}>{report.icsSurveillanceSummary}</Typography>
                  ) : (
                    <Typography className={classes.responseBox}>No response entered</Typography>
                  )}
                </Box>
                ...
                <Box className={classes.summaryGroup}>
                  ...
                  <Typography className={classes.question} variant="body2" gutterbottom>The ONC-ACB undertook the following activities and implemented the following measures to evaluate and address the prioritized elements of surveillance referred to in Program Policy Resource #18-03 (October 5, 2018).</Typography>
                </Box>
                <Box className={classes.summaryGroup}>
                  <Typography variant="h6" style={{ fontWeight: 'bold' }} gutterbottom>Prioritized Criteria</Typography>
                  <Typography className={classes.question} variant="body2" gutterbottom>Please describe which prioritized criteria were surveilled, how and with what frequency. Summarize the approach taken to conduct surveillance on these prioritized criteria.</Typography>
                  {report.prioritizedElementSummary ? (
                    <Typography className={classes.responseBox}>{report.prioritizedElementSummary}</Typography>
                  ) : (
                    <Typography className={classes.responseBox}>No response entered</Typography>
                  )}
                </Box>
                <Box className={classes.summaryGroup}>
                  ...
                  {report.disclosureRequirementsSummary ? (
                    <Typography className={classes.responseBox}>{report.disclosureRequirementsSummary}</Typography>
                  ) : (
                    <Typography className={classes.responseBox}>No response entered</Typography>
                  )}
                </Box>
                <Box className={classes.summaryGroup}>
                  ...
                  {report.developerComplaintsLogReview ? (
                    <Typography className={classes.responseBox}>{report.developerComplaintsLogReview}</Typography>
                  ) : (
                    <Typography className={classes.responseBox}>No response entered</Typography>
                  )}
                </Box>
                <Box className={classes.summaryGroup}>
                  ...
                  <Typography className={classes.question} variant="body2" gutterbottom>The assessment of potential non-conformities resulting from implementation or business practices of a developer that could affect the performance of certified capabilities in the field.</Typography>
                  {report.postCertificationPerformanceOfCertifiedCapabilities ? (
                    <Typography className={classes.responseBox}>{report.postCertificationPerformanceOfCertifiedCapabilities}</Typography>
                  ) : (
                    <Typography className={classes.responseBox}>No response entered</Typography>
                  )}
                </Box>
                <Box className={classes.summaryGroup}>
                  ...
                  <Typography className={classes.question} variant="body2" gutterbottom>Describe activities and frequency of assessment of the appropriate use of the ONC Health IT Certification and Design Mark on developer public-facing materials.</Typography>
                  {report.appropriateUseOfMark ? (
                    <Typography className={classes.responseBox}>{report.appropriateUseOfMark}</Typography>
                  ) : (
                    <Typography className={classes.responseBox}>No response entered</Typography>
                  )}
                </Box>
                <Box className={classes.summaryGroup}>
                  ...
                  {report.complaintsReportedToOncAcb ? (
                    <Typography className={classes.responseBox}>{report.complaintsReportedToOncAcb}</Typography>
                  ) : (
                    <Typography className={classes.responseBox}>No response entered</Typography>
                  )}
                </Box>
