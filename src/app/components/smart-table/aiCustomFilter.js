(function () {
    ...
    function CustomFilter ($filter) { // will need cfpLoadingBar back if we want the "spinny circle" on smart-table filtering
        ...
        return function customFilter (array, expression) {
            ...
            function dateRangeComparator (actual, expected) {
            ...
            function distinctComparator (actual, expected) {
            ...
            function matchAnyComparator (actual, expected) {
            ...
            function matchAllComparator (actual, expected) {
                let ret;
                let separator = expected.separator ? expected.separator : '';
            ...
            function nonconformityComparator (actual, expected) {
            ...
            function rangeComparator (actual, expected) {
                if (expected.lower) {
            ...
            function surveillanceComparator (actual, expected) {
