(function () {
    ...
    angular.module('chpl.components')
        ...
        .directive('chplDateRange', chplDateRange);

    function chplDateRange () {
        return {
            bindToController: {
                hasChanges: '=?',
                nameSpace: '@?',
    ...
    /** @ngInclude */
    function ChplDateRangeController ($analytics, $filter, $localStorage) {
        var vm = this;
