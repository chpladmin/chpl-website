(function () {
    ...
    describe('the SED Display', function () {
        var $compile, $log, $timeout, $uibModal, Mock, actualOptions, el, mock, scope, utilService, vm;
        ...
        beforeEach(function () {
            ...
            inject(function (_$compile_, _$log_, $rootScope, _$timeout_, _$uibModal_, _Mock_, _utilService_) {
                $compile = _$compile_;
                $log = _$log_;
                Mock = _Mock_;
