(() => {
    ...
    fdescribe('the Product component', () => {
        ...
        beforeEach(() => {
            ...
            inject((_$compile_, _$log_, $rootScope) => {
                ...
                el = angular.element('<chpl-product product="product" developer="developer" can-edit="canEdit" can-merge="canMerge" can-split="canSplit" on-edit="onEdit()" on-split="onSplit()"></chpl-product>');
