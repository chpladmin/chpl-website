    ...
    controller: class SurveillanceEditController {
        ...
        addRequirement () {
            this.modalInstance = this.$uibModal.open({
                ...
                keyboard: false,
                resolve: {
                    disableValidation: () => { return false; },
                    randomized: () => { return this.surveillance.type.name === 'Randomized'; },
                    randomizedSitesUsed: () => { return this.surveillance.randomizedSitesUsed; },
                    requirement: () => { return { nonconformities: [] }; },
                    surveillanceId: () => { return this.surveillance.id; },
                    surveillanceTypes: () => { return this.data; },
                    workType: () => { return 'add'; },
                },
                size: 'lg',
            });
        ...
        editRequirement (req) {
            ...
            this.modalInstance = this.$uibModal.open({
                ...
                keyboard: false,
                resolve: {
                    disableValidation: () => { return this.disableValidation; },
                    randomized: () => { return this.surveillance.type.name === 'Randomized'; },
                    randomizedSitesUsed: () => { return this.surveillance.randomizedSitesUsed; },
                    requirement: () => { return req; },
                    surveillanceId: () => { return this.surveillance.id; },
                    surveillanceTypes: () => { return this.data; },
                    workType: () => { return this.workType; },
                },
                size: 'lg',
            });
            this.modalInstance.result.then(response => {
