...
lookup = {
  ...
  'surveillances.surveillanceOutcome.name': { message: (before, after) => comparePrimitive(before, after, 'name', 'Name') },
  ...
  'surveillances.surveillanceProcessType.name': { message: (before, after) => comparePrimitive(before, after, 'name', 'Name') },
