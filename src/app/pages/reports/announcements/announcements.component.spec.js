(() => {
    ...
    xdescribe('the Reports.Announcements component', () => {
        ...
        describe('controller', () => {
            ...
            describe('helper functions', () => {
                ...
                describe('when determining the type of change', () => {
                    it('should correctly identify if a new announcement was created', () => {
                        let detail = {
                            newData: true,
                            originalData: null,
                        };
                        expect(ctrl.isActivityNewAnnouncement(detail)).toBe(true);
                    });
                    it('should correctly identify if a new announcement was NOT created', () => {
                        let detail = {
                            newData: true,
                            originalData: true,
                        };
                        expect(ctrl.isActivityNewAnnouncement(detail)).toBe(false);
                    });
                    it('should correctly identify if a announcement was deleted', () => {
                        let detail = {
                            newData: null,
                            originalData: true,
                        };
                        expect(ctrl.isActivityDeletedAnnouncement(detail)).toBe(true);
                    });
                    it('should correctly identify if a announcement was NOT deleted', () => {
                        let detail = {
                            newData: true,
                            originalData: true,
                        };
