    ...
    controller: class ListingComponent {
        ...
        loadResources () {
            ...
            this.$q.all([
                ...
                this.networkService.getMeasures().then(response => that.resources.measures = response),
                this.networkService.getMeasureTypes().then(response => that.resources.measureTypes = response),
