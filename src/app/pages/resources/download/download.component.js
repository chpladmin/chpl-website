    ...
    controller: class ResourcesDownloadComponent {
        ...
        $onInit () {
            ...
            this.downloadOptions = [
                ...
                { data: this.API + '/developers/direct-reviews/download?api_key=' + this.API_KEY, definition: this.API + '/developers/direct-review/download?api_key=' + this.API_KEY + '&definition=true', label: 'Direct Review Activity', display: 'Direct Review Activity'},
            ];
