...
function ChplResourcesDownload() {
  ...
  useEffect(() => {
    const data = {
      ...
      'SVAP Summary (csv)': { data: `${API}/svap/download?api_key=${getApiKey()}`, definition: `${API}/svap/download?api_key=${getApiKey()}`, label: 'SVAP Summary' },
    };
    setFiles(data);
              ...
              <div className={classes.fullWidth}>
                <div>
                  <Typography variant="body1">
                    The XML definition files were last modified on December 12, 2022.
                  </Typography>
                </div>
              </div>
            </CardContent>
