const DevelopersAttestationComponent = {
  templateUrl: 'chpl.organizations/developers/developer/attestation.html',
  bindings: {
    developer: '<',
  },
  controller: class DevelopersAttestationComponent {
...
angular.module('chpl.organizations')
  .component('chplDevelopersAttestation', DevelopersAttestationComponent);

export default DevelopersAttestationComponent;
