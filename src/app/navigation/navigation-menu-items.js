...
const getResourceItems = ({ domainIsOn, includeDeveloperGuide }) => {
  ...
  if (includeDeveloperGuide) {
    baseItems.push({
      ...
      href: domainIsOn
        ? 'https://www.astp.hhs.gov/sites/default/files/policy/chpl_developer_user_guide.pdf'
        : 'https://www.healthit.gov/sites/default/files/policy/chpl_developer_user_guide.pdf',
