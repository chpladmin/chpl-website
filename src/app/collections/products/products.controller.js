(function () {
    ...
    /** @ngInject */
    function DecertifiedProductsController ($filter, $localStorage, $log, $rootScope, $scope, $timeout, CACHE_TIMEOUT, RELOAD_TIMEOUT, commonService) {
        var vm = this;
        ...
        function triggerRestoreState () {
            if ($localStorage.nonconformitiesTableState) {
                var state = angular.fromJson($localStorage.decertifiedProductsTableState);
        ...
        function restoreResults () {
            if ($localStorage.decertifiedProductsTableState) {
                $timeout(
                    function () {
