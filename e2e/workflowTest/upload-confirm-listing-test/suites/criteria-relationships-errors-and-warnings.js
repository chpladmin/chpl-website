const suite = {
  ...
  listings: [{
    ...
    expectedWarnings: [
      'The criterion 170.315 (g)(9) (Cures Update) was attested to multiple times in the upload file. Only one version of the criterion was saved with the listing. Please check the uploaded listing and update the file as needed.',
      'The criterion 170.315 (g)(6) (Cures Update) was attested to multiple times in the upload file. Only one version of the criterion was saved with the listing. Please check the uploaded listing and update the file as needed.',
      'The criterion 170.315 (f)(5) (Cures Update) was attested to multiple times in the upload file. Only one version of the criterion was saved with the listing. Please check the uploaded listing and update the file as needed.',
      'The criterion 170.315 (e)(1) (Cures Update) was attested to multiple times in the upload file. Only one version of the criterion was saved with the listing. Please check the uploaded listing and update the file as needed.',
      'The criterion 170.315 (d)(3) (Cures Update) was attested to multiple times in the upload file. Only one version of the criterion was saved with the listing. Please check the uploaded listing and update the file as needed.',
      'The criterion 170.315 (d)(2) (Cures Update) was attested to multiple times in the upload file. Only one version of the criterion was saved with the listing. Please check the uploaded listing and update the file as needed.',
      'The criterion 170.315 (d)(10) (Cures Update) was attested to multiple times in the upload file. Only one version of the criterion was saved with the listing. Please check the uploaded listing and update the file as needed.',
      'The criterion 170.315 (c)(3) (Cures Update) was attested to multiple times in the upload file. Only one version of the criterion was saved with the listing. Please check the uploaded listing and update the file as needed.',
      'The criterion 170.315 (b)(9) (Cures Update) was attested to multiple times in the upload file. Only one version of the criterion was saved with the listing. Please check the uploaded listing and update the file as needed.',
      'The criterion 170.315 (b)(8) (Cures Update) was attested to multiple times in the upload file. Only one version of the criterion was saved with the listing. Please check the uploaded listing and update the file as needed.',
      'The criterion 170.315 (b)(7) (Cures Update) was attested to multiple times in the upload file. Only one version of the criterion was saved with the listing. Please check the uploaded listing and update the file as needed.',
      'The criterion 170.315 (b)(3) (Cures Update) was attested to multiple times in the upload file. Only one version of the criterion was saved with the listing. Please check the uploaded listing and update the file as needed.',
      'The criterion 170.315 (b)(2) (Cures Update) was attested to multiple times in the upload file. Only one version of the criterion was saved with the listing. Please check the uploaded listing and update the file as needed.',
      'The criterion 170.315 (b)(1) (Cures Update) was attested to multiple times in the upload file. Only one version of the criterion was saved with the listing. Please check the uploaded listing and update the file as needed.',
    ],
  }, {
