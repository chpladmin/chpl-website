const suite = {
  ...
  listings: [{
    ...
    expectedWarnings: [
      ...
      'Criteria 170.315 (b)(1) contains an optional standard \'BAD OS\' which does not exist. It has been removed.',
      'Optional Standard WCAG 2.0, Level AA Conformance is not valid for criteria 170.315 (b)(1). It has been removed.',      
