const suite = {
  ...
  listings: [{
    ...
    expectedErrors: [
        ...
        'Real World Testing Results Check Date \'n/a\' is not a valid date format. Please enter date as yyyy-MM-dd.',
        'Real World Testing Plans URL is not a well formed URL.',
        'Real World Testing Plans Check Date \'Jany 7 1998\' is not a valid date format. Please enter date as yyyy-MM-dd.',
    ],
    expectedWarnings: [
    ],
  }],
