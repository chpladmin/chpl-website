const suite = {
  ...
  listings: [{
    ...
    expectedErrors: [
      'There was no version found for test tool Edge Testing Tool and certification 170.315 (g)(6).',
      ...
      'Certification 170.315 (b)(1) contains Privacy and Security Framework value \'Approach 3 and 4\' which must match one of \'Approach 1\', \'Approach 2\', \'Approach 1;Approach 2\'.',
    ...
    expectedWarnings: [
      ...
      'Criteria 170.315 (b)(1) contains an invalid test tool \'test tool\'. It has been removed from the pending listing.',
      ...
      'Test data \'test data\' is invalid for the criterion 170.315 (b)(1) and has been removed from the listing.',
      'Certification 170.315 (b)(1) contains duplicate Test Tool: Name \'Edge Testing Tool\', Version \'4\'. The duplicates have been removed.',
      'Certification 170.315 (b)(1) contains duplicate Test Data: Name \'ONC Test Method\', Version \'5\'. The duplicates have been removed.',
