...
describe('the compare page', () => {
  ...
  it('should correctly display the criteria number/title', () => {
    expect(page.getCellWithCriteriaId('1').getText()).toBe('170.315 (a)(1): Computerized Provider Order Entry (CPOE) - Medications');
  });

  it('should correctly display the retired criteria number/title', () => {
    expect(page.getCellWithCriteriaId('27').getText()).toContain('Removed | 170.315 (c)(3): Clinical Quality Measures - Report');
  });
});
