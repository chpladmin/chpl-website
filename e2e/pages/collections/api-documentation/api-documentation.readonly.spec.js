...
describe('the Api Documentation collection page', () => {
  ...
  it('should have table headers in a defined order', async () => {
    const expectedHeaders = ['CHPL ID', 'Certification Edition', 'Developer', 'Product', 'Version', 'Certification Status', 'API Documentation', 'Service Base URL List', 'Mandatory Disclosures URL', 'Actions'];
