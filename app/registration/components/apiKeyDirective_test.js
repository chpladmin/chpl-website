;(function () {
    ...
    describe('app.registration.apiKey.directive', function () {
        ...
        beforeEach(function () {
            ...
            module('app/registration/components/apiKey.html');
        ...
        beforeEach(inject(function ($compile, $rootScope, $templateCache) {
            ...
            var template = $templateCache.get('app/registration/components/apiKey.html');
            $templateCache.put('registration/components/apiKey.html', template);
